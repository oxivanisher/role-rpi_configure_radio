...
Enable or disable the wifi and bluetooth adapter. Also disable wifi powersave for wifi enabled devices and unblocks the devices with rfkill if they are soft blocked.
